...
- **Orbwalker feedback states**: The follow section now renders inline success and validation feedback, including an alert message and ActiveRecord error list when newsletter form submission fails validation. (source: `app/views/pages/orbwalker.html.erb`, `app/controllers/contacts_controller.rb`)
